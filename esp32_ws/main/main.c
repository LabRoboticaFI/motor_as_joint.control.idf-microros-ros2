...
joint_t joint1 = {
	...
	.encoder.config = {
		...
		.encoder_ratio = 1120, // Cantidad de ticks por vuelta del motor
	...
	.control.quintico.config = {
		.periodo_quintico = 1*1000*1000, // en micro-segundos (us)
	},
...
//encoder.pcnt_handle = NULL,
//encoder.q_tick_counter = 0,
